...
const output='/tmp/hermes-mobile-slash-evidence';await mkdir(output,{recursive:true});
...
try{
 ...
 assert.deepEqual(await b.evaluate("__productionFixture.trace.filter(t=>t.method==='slash.exec').map(t=>t.params.profile)"),['default','qa-bot']);
