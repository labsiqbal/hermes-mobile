...
export function Appearance({ embedded = false }: { embedded?: boolean }) {
  ...
  const controls = <div className="appearance-controls">
  ...
  return embedded ? controls : <div className="screen"><div className="body">{controls}</div></div>;
}
