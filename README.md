...
- Set **Manage → Appearance & preferences → UI scale** to 75% Compact, 100% Standard (default), or 125% Large. Appearance stays local to this browser; it does not change the Desktop Accent plugin or gateway/profile defaults.
